        ...
        <div className={styles.demo} style={animate ? fullPath : {}}>
          ...
          <div className={styles.canvas} >
            <div className={styles.labelContainer}>
              ...
              <h1 className={styles.demoText} data-att='home'>Home</h1>
            </div>
            <div className={styles.labelContainer}>
              <h1 className={styles.index}>02</h1>
              <h1 className={styles.demoText} data-att='about'>About</h1>
            </div>
            <div className={styles.labelContainer}>
              <h1 className={styles.index}>03</h1>
              <h1 className={styles.demoText} data-att='contact'>Contact</h1>
            </div>
          </div>
        </div>
